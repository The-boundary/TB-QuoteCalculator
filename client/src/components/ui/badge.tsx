  ...
  'inline-flex items-center rounded-md border px-2 py-0.5 text-[13px] leading-4 gap-1 font-normal transition-colors focus:outline-none focus:ring-2 focus:ring-sb-brand focus:ring-offset-2 focus:ring-offset-sb-bg',
  {
    variants: {
      variant: {
        ...
        default: 'border-sb-brand/30 bg-sb-brand-300 text-sb-brand',
        // Secondary: Dark surface
        secondary: 'border-sb-border bg-sb-surface-200 text-sb-text-light',
        // Outline: Transparent
        outline: 'border-sb-border-strong bg-transparent text-sb-text-muted',
        // Destructive: Red
        destructive: 'border-red-800 bg-red-950 text-red-400',
        // Success: Cyan
        success: 'border-cyan-800 bg-cyan-950 text-cyan-400',
        // Warning: Amber
